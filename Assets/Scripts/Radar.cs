...
public class Radar : MonoBehaviour
{
    ...
    public void OnSpawnEventResponse(GameObject gameObject)
    {
        RegisterRadarObject(gameObject, gameObject.GetComponent<RadarEntity>().image);
    }

    public void OnPickupEventResponse(GameObject gameObject)
    {
